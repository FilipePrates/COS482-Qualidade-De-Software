...
import CustomerServiceProcessService from '@/entities/customer-service-process/customer-service-process.service';
...
new Vue({
  ...
  provide: {
    ...
    customerServiceProcessService: () => new CustomerServiceProcessService(),
